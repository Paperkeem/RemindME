...
⭐️ 내가 만든 **URL 카드를 드래그 앤 드롭**하여 자유롭게 위치시켜 보세요.
<br />
...
⭐️ 카드 이름과 URL 주소를 적어 **URL 카드를 만들어 보세요.**
<br />
...
- [x] 카드 삭제 기능
- **쓰레기통 아이콘에 카드를 드래그하면 삭제**하는 기능을 구현하기 위해서 `Droppable` 영역을 할당, droppableId는 trash로 설정
...
- 보드를 추가 시, 새로운 name을 보드 name 배열과 카드 객체에 각각 저장
